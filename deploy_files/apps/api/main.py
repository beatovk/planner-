...
app.include_router(admin_places.router, prefix="/api", tags=["admin"])
app.include_router(parse.router,        prefix="/api", tags=["parse"])
app.include_router(compose.router,      prefix="/api", tags=["compose"])
app.include_router(feedback.router,     prefix="/api", tags=["feedback"])
app.include_router(config.router,       prefix="/api", tags=["config"])
app.include_router(debug_version.router,prefix="/api", tags=["debug"])
app.include_router(_dbdiag_router,      prefix="/api", tags=["debug"])
