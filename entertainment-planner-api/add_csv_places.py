#!/usr/bin/env python3
"""
Скрипт для добавления мест из CSV файла в базу данных
"""
    ...
    try:
        with open(csv_file_path, 'r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                if existing_place:
                    print(f"⚠️  Пропущено: место '{name}' уже существует (ID: {existing_place.id})")
                    skipped_count += 1
                    continue
...
def main():
    """Основная функция"""
    csv_file_path = "../docs/places.csv/1.csv"
