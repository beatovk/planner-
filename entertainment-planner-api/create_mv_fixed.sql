-- Create materialized view with all required columns and derived flags
...
WITH base AS (
  SELECT
    ...
    COALESCE(p.signals::jsonb, '{}'::jsonb) AS signals,
